...
<footer id="footer" class="site-footer" role="contentinfo">
	<div class="container">
		<div class="col-lg-12">
			<div class="site-info">
				<?php printf( esc_html__( 'Los textos de este blog están bajo una %s, las imágenes pertenecen a sus respectivos autores.'), '<a href="http://creativecommons.org/licenses/by-sa/3.0/deed.es_CO">Licencia Creative Commons Atribución-Compartir Igual</a>');?><br />
				<?php printf( esc_html__('Themed by %s. Powered by %s.', 'shamrock' ), '<a href="http://mekshq.com" target="_blank">Meks</a>' , '<a href="http://wordpress.org" target="_blank">WordPress</a>' ); ?>
			</div>
