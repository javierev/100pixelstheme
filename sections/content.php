<article id="post-<?php the_ID(); ?>" <?php post_class( 'smr-post' ); ?>>
	...
	<div class="outer-entry-header-wrapper">
		<div class="middle-entry-header-wrapper">
			<div class="entry-header-wrapper" style="position:relative;left:-50%;float:right;width:auto">
	...
	<div class="entry-content">
		...
		<?php else : ?>
			...
			<p><a href="<?php echo esc_url( get_permalink() ); ?>" class="more-link">Seguir leyendo</a></p>
		<?php endif; ?>
	</div>
</article>
